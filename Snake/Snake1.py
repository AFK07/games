...
#             TILE_SIZE * 10)
# this code is to initialise the game with the snake head and food with designations 
snake = Tile(random.randint(0, COLS-1) * TILE_SIZE, 
             random.randint(0, ROWS-1) * TILE_SIZE)

food = Tile(random.randint(0, COLS-1) * TILE_SIZE, 
            random.randint(0, ROWS-1) * TILE_SIZE)
# not to be confused: replacing the 5 with random.randint(0, cols or rows-1)
# what it does it creates random numbers between 0 and the given cols or rows
